...
export const MOVIES_DATA: Movie[] = [
  {
    ...
    synopsis: 'An epic action-saga set in coastal lands, depicting the journey of an alpha man who dares to command the seas and rewrite destiny to protect his people.',
  },
  {
    id: 'm2',
    ...
    synopsis: 'The clash continues between Pushpa Raj and SP Bhanwar Singh Shekhawat. Pushpa establishes an international syndicate, enforcing his rule with unmatched grit and style.',
  },
  {
    id: 'm3',
    ...
    synopsis: 'A decade after the events of Jurassic World, a specialized team attempts to secure DNA samples from the three most colossal creatures left on Earth, hidden deep in tropical biospheres.',
  },
  {
    id: 'm4',
    title: 'Kalki 2898 AD',
    ...
    synopsis: 'In a post-apocalyptic city of Kasi, a modern avatar of Vishnu is born to save the world from the dark forces of Supreme Yaskin, guarded by the immortal Aswatthama.',
  }
];
